...
package com.bioenable.mlkit.vision.demo

import android.content.Intent
import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import android.widget.TextView
import com.bioenable.mlkit.vision.demo.java.ChooserActivity
    ...
    findViewById<TextView>(R.id.kotlin_entry_point).setOnClickListener {
      val intent =
        Intent(
          ...
          com.bioenable.mlkit.vision.demo.kotlin.ChooserActivity::class.java
        )
      startActivity(intent)
    }
  }
